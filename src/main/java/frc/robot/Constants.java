...
public final class Constants {
  ...
  public static final double maxModuleAcceleration = 4.5;
  //changes speed ACTUALLY CHANGES SPEED
  public static final double maxTranslationalDriveSpeed = 4.5;
  public static final double minTranslationalDriveSpeed = 3;
