...
public class AutoForwardsCommand extends Command {
   ...
   */
  public AutoForwardsCommand(DriveSubsystem driveSubsystem, double speed, double distance, boolean isFieldCentric) {
